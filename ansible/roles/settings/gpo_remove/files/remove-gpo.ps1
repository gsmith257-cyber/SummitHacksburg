Remove-GPLink -Name "StarkWallpaper" -Target "OU=North,OU=kingdoms,DC=hacksburg,DC=local" -erroraction 'silentlycontinue'
...
New-GPLink -Name "Remove-StarkWallpaper" -Target "OU=North,OU=kingdoms,DC=hacksburg,DC=local"
